  ...
  return (
    <Layout>
      <div className="bg-gray-50 py-20 px-4 min-h-screen">
        <Head>
          <title>Kumquat Partners | Contact Us</title>
        </Head>
            ...
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">+234 703 384 5783</p>
                  <p className="text-gray-600 text-sm">+234 701 209 5049</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">info@kumquatp.com</p>
                </div>
              </div>
            </motion.div>
